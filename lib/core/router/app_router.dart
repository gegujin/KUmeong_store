// lib/core/router/app_router.dart  (파일명은 네가 쓰는 경로에 맞춰 사용)
            ...
            GoRoute(
              ...
              routes: [
                ...
                GoRoute(
                  ...
                  builder: (context, state) {
                    final meUserId = (state.extra as String?) ??
                        '11111111-1111-4111-8111-111111111111'; // TODO: 실제 로그인 값으로 교체
