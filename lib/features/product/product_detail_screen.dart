...
//                     try {
//                       // ✅ 상품의 UUID (이미 UUID라면 그대로, 필요 외에는 normalize 사용 X)
//                       final productId = widget.product.id;

//                       // ✅ 채팅 API 인스턴스 (세션에서 meUserId 받아오기)
//                       final chatsApi = ChatApi(meUserId: session.me!.id);

//                       // ✅ 거래 채팅방 멱등 생성 (없으면 생성, 있으면 그대로 반환)
...
//                       ScaffoldMessenger.of(context).showSnackBar(
//                         const SnackBar(content: Text('채팅방 생성에 실패했어요. 다시 시도해주세요.')),
//                       );
//                     } finally {
//                       if (mounted) {
